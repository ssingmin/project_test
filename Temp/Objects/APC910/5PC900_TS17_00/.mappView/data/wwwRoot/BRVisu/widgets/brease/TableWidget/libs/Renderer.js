define([
    ...
    */
    ...
    p.initialize = function () {
        ...
        this.throttledRedraw = _.throttle(this._redraw, this.getRedrawWaitTime(), {
            'leading': false,
            'trailing': true
        });
    ...
    //returns the wait time for the throttle function for the redraw
    p.getRedrawWaitTime = function () {
        return 300;
    };
